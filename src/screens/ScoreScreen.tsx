  ...
  return (
    <div className="relative w-full h-full overflow-hidden">
      ...
      <div className="relative z-10 w-full h-full">
        ...
        {/* LEFT: Lumi avatar — centered at ~26% horizontally */}
        <motion.div
          className="absolute bottom-0 left-0 flex items-end justify-center"
          style={{ width: "52%", top: 0 }}
        ...
        {/* RIGHT: Score content — Figma stat cards at x=2158(56.2%) */}
        <motion.div
          className="absolute flex flex-col gap-6"
          style={{ left: "56.2%", top: "16.7%", width: "27.5%" }}
          initial={{ opacity: 0, x: 40 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.7 }}
        >
          {/* Title */}
          <motion.h1
            className="font-heading font-bold text-5xl md:text-6xl tracking-wider energy-gradient-text mb-2"
          ...
          >
            <div className="text-6xl md:text-7xl font-bold font-heading text-white mb-2">
              {score}/{maxScore}
            </div>
            <div className="text-2xl font-heading text-energy-green mb-2">
              {percentage}%
            </div>
          </motion.div>
          ...
          {onNext && (
            ...
            >
              ...
              <span className="text-white/80 font-medium">Continue</span>
            </motion.div>
          )}
        </motion.div>
